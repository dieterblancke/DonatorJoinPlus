...
public class MessageBuilder
{
    ...
    public static TextComponent buildMessage( final ProxiedPlayer player, final Object message, final Object... placeholders )
    {
        if (
        ...
        else
        {
            ...
            return new TextComponent( TextComponent.fromLegacyText( BungeeUtils.formatString( player, messageString ) ) );
        }
    }

    public static TextComponent buildMessage( final ProxiedPlayer player,
    ...
    public static List<TextComponent> buildMessage( final ProxiedPlayer player, final List<ISection> sections, final Object... placeholders )
    {
    ...
    private static BaseComponent[] searchAndFormat( final ProxiedPlayer player,
                                                    final String str,
                                                    final Object... placeholders )
    {
        return TextComponent.fromLegacyText( format( BungeeUtils.formatString( player, str ), placeholders ) );
    }
    ...
    private static BaseComponent[] searchHoverMessageAndFormat( final ProxiedPlayer player,
                                                                final ISection section,
                                                                final Object... placeholders )
    {
        if ( section.isList( "hover" ) )
        {
            return BungeeUtils.format(
                    player,
                    format(
