...
public abstract class HikariStorageManager extends AbstractStorageManager
{
    ...
    private void initVolumePitchColumns( final Connection connection, final DatabaseMetaData metaData ) throws SQLException
    {
        ...
        {
            try ( PreparedStatement pstmt = connection.prepareStatement(
                    "ALTER TABLE djp_data ADD join_volume " + intType + " DEFAULT NULL;" )
            )
            {
                pstmt.execute();
            }
        ...
        {
            try ( PreparedStatement pstmt = connection.prepareStatement(
                    "ALTER TABLE djp_data ADD join_pitch " + intType + " DEFAULT NULL;" )
            )
            {
                pstmt.execute();
            }
        ...
        {
            try ( PreparedStatement pstmt = connection.prepareStatement(
                    "ALTER TABLE djp_data ADD leave_volume " + intType + " DEFAULT NULL;" )
            )
            {
                pstmt.execute();
            }
        ...
        {
            try ( PreparedStatement pstmt = connection.prepareStatement(
                    "ALTER TABLE djp_data ADD leave_pitch " + intType + " DEFAULT NULL;" )
            )
            {
                pstmt.execute();
            }
